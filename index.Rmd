...
During the Fall semester of 2026, students will undertake nighttime Area Studies of five Philadelphia sites. Part of this process will involve data analysis of relevant information - public safety incidents, zoning, business licenses, and more.
...
study_areas <- st_read("https://raw.githubusercontent.com/mafichman/cpln_6890/refs/heads/main/study_areas/2026/geojson/studyAreas2026_v2.geojson")
```
```{r echo=FALSE, message=FALSE, warning=FALSE}
mapview(study_areas, label = "study_areas$Name", legend = FALSE)
...
You can consult [Section 14-602 of the Philadelphia Code](https://codelibrary.amlegal.com/codes/philadelphia/latest/philadelphia_pa/0-0-0-292339) to understand what kinds of uses are prohibited in each zoning district, including several categories related to assembly, events, food service, and other commercial uses.

# Licensing

[PA Liquor Control Board Licenses - Philadelphia County - 2025](https://github.com/mafichman/cpln_6890/blob/main/plcb_licenses/2026/PHL_PLCB_geocoded.csv)
...
3. Wide data - these are place names, weekly hour schedules, uses/types of business (as a list and as true/false by type), and open/close times for each day in column form.  You may need to clean these data a bit. Places that are open 24 hours show "NA" for closing times in the wide data ... but places that are just plain missing information... also show NA.  You will need to pick through and figure out what's what - deleting the businesses that might happen to be non-operational or just have no relevant listed hours. There are also some places that have multiple closing times on a given day ... for example if you close at 2AM on Saturday night (e.g. 0200 on Sunday), and 11PM on Sunday night (e.g. 2300 on Sunday), you will have multiple times listed for a given day.

4. Long data - these data are similar to the wide data EXCEPT, each place has 7 rows in the data set, one for each day of the week. In this data set, there are columns for hours 0, 1, 2... up to 23, with a 0/1 indicator noting whether the business is open. Again - you might need to clean out businesses that are defunct or don't have relevant "hours", because these show up in the google data just like 24-hour businesses - with no listed open/close times! Be careful to clean those out of your data.

[Google Places - Wide Data](https://github.com/mafichman/cpln_6890/blob/main/places/google_places_82626.geojson/)

[Google Places - Long Data](https://github.com/mafichman/cpln_6890/blob/main/places/google_places_LONG_82626.geojson/)
...
[Registered Community Organizations](https://opendataphilly.org/datasets/registered-community-organizations-rco-boundaries/)

[Business Improvement Districts](https://opendataphilly.org/datasets/business-improvement-districts/)

[Commercial Corridor Boundaries](https://opendataphilly.org/datasets/commercial-corridors-of-philadelphia/)
