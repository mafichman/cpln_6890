...
2. The Google Places API is not perfect - I pulled data for a handful of business categories but there are probably some that were missed, and there are inaccurate data - these are user input data!
